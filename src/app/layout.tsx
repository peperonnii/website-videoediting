...
import { Geist, Geist_Mono, Tomorrow, Yesteryear, Syne_Mono, Zen_Dots } from "next/font/google";
...
const zendots = Zen_Dots({
  ...
  subsets: ["latin"], // You can include other subsets as needed
  variable: "--font-zendots",  // Optional: Declare a CSS variable for easy use
});
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${tomorrow.variable} ${yesteryear.variable} ${zendots.variable} ${geistSans.variable} ${geistMono.variable} ${syne.variable} antialiased`}
      >
        {children}
        <Analytics />
        <SpeedInsights />
